...
STARTERS: dict[str, list[Suggestion]] = {
    ...
    "manufacturing": [
        # A bearings and power-transmission counter, in the order one is walked through:
        # the common ball bearings first, then housings, then what goes around them.
        _s("6204 ZZ ball bearing", "Bearings", "piece", 190, 132, "gear"),
        _s("6205 2RS ball bearing", "Bearings", "piece", 240, 168, "gear"),
        _s("6206 ZZ ball bearing", "Bearings", "piece", 310, 222, "gear"),
        _s("6305 2RS ball bearing", "Bearings", "piece", 420, 300, "gear"),
        _s("30205 taper roller bearing", "Bearings", "piece", 520, 372, "gear"),
        _s("22210 spherical bearing", "Bearings", "piece", 2450, 1790, "gear"),
        _s("UCP 205 pillow block", "Housings", "piece", 690, 480, "gear"),
        _s("UCF 206 flange unit", "Housings", "piece", 820, 590, "gear"),
        _s("SN 510 plummer block", "Housings", "piece", 3250, 2400, "gear"),
        _s("V-belt B-56", "Belts", "piece", 410, 290, "gear"),
        _s("V-belt C-90", "Belts", "piece", 980, 700, "gear"),
        _s("Chain 08B-1 10ft", "Chains", "piece", 1180, 860, "gear"),
        _s("Sprocket 08B-1 Z18", "Chains", "piece", 640, 450, "gear"),
        _s("Flexible coupling L-095", "Couplings", "piece", 1350, 980, "gear"),
        _s("Oil seal 35x52x7", "Seals", "piece", 95, 58, "gear"),
        _s("Oil seal 50x72x10", "Seals", "piece", 145, 92, "gear"),
        _s("Hex bolt M12", "Fasteners", "piece", 28, 17, "bolt"),
        _s("Bearing grease 500g", "Consumables", "piece", 280, 195, "bottle"),
    ],
    "distribution": [
